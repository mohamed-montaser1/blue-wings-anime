  ...
  return (
    <div className="flex justify-between items-center gap-24 mt-3 max-[991px]:gap-4 min-[779px]:pl-16 pt-10 min-[900px]:max-h-[410px] h-fit mb-16 relative max-[767px]:h-full">
      ...
      <div className="content max-[767px]:px-5">
        <span className="text-sm text-white max-[767px]:text-center block">
          الفصل: {info.chapter}
        </span>
        <h1 className="text-white text-3xl mt-2 mb-1 max-[991px]:text-2xl max-[767px]:text-center">
          {info.title}
        </h1>
        <p className="text-white text-[14px] max-[602px]:text-2.5 max-[767px]:text-center">
          {info.description}
        </p>
      </div>
    </div>
